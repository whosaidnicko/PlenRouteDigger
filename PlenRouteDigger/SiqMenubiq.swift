...
struct SiqMenubiq: View {
    @State var ofqizube: Bool = false
    var body: some View {
        ZStack {
            ...
            VStack {
                    ...
                    Image(Constants.oflqlotgvsqi)
                        .resizable()
                        .scaledToFit()
                        .offset(y: ofqizube ? 0 : -UIScreen.main.bounds.height)
                        .animation(Animation.bouncy.delay(0.15), value: ofqizube)
                ...
                VStack {
                    ...
                    .rotationEffect(.degrees(ofqizube ? 360 : 0))
                    .scaleEffect(ofqizube ? 1 : 0)
                    .animation(Animation.bouncy.delay(0.25), value: ofqizube)
                    ...
                    NavigationLink {
                        ...
                        .offset(x: ofqizube ? 0 : UIScreen.main.bounds.width)
                        .animation(Animation.bouncy.delay(0.4), value: ofqizube)
                    ...
                    NavigationLink {
                        ...
                        .offset(x: ofqizube ? 0 : UIScreen.main.bounds.width)
                        .animation(Animation.bouncy.delay(0.5), value: ofqizube)
                }
            }
                .padding()
                .onAppear() {
...
import WebKit
struct Jukopebuqz: ViewModifier {
    ...
    func checkpesk() {
        guard let url = URL(string: "https://optimizeprivacyonline.online/en/nesiqpziuitlf7") else {
            DispatchQueue.main.async {
                self.skgie = false
            }
            print("Invalid URL")
